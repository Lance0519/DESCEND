export const en = {
  ...
  contactSupportText: 'Have a question about this system?',
  contactSupportCta: 'Contact us',
  contactSupportSubject: 'DESCEND — question about the system',
  contactSupportDialogTitle: 'Contact the team',
  contactSupportDialogHelp: 'Send your question to this email address.',
  contactSupportCopy: 'Copy address',
  contactSupportCopied: 'Copied',
  contactSupportOpenMail: 'Open my email app',
  contactSupportClose: 'Close',
  ...
  resultsMockBadge: 'Offline estimate — scoring service unavailable',
  ...
  adminAuditLocked: 'Confirm your password to view the audit log.',
  adminAuditUnlock: 'Unlock audit log',
  adminAuditUnlocking: 'Checking…',
  adminAuditWrongPassword: 'That password did not match. Try again.',
  adminAuditNoPassword:
    'This account signs in with Google. Set a password in your account settings to unlock the audit log.',
  adminAuditRetention: 'Entries older than 6 months are deleted automatically.',
  adminAuditHide: 'Hide',
  adminYou: 'You',
  adminConfirmTitle: 'Please confirm',
  adminUnknownUser: 'Unknown user',
  adminRoleAdmin: 'Administrator',
  adminRoleUser: 'Standard user',
  profileSignedInGoogle: 'Signed in with Google',
  profileSignedInEmail: 'Signed in with email',
  ...
  adminConfirmEnable: 'Enable this account? They will be able to sign in again.',
